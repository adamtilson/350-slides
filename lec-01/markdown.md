...
- not: Is it raining?
- e.g.
$$ \exists n \forall n \in \mathbb{N}, n^2 + n + 41 \text{ is a prime number} $$ 
...
The exists some numbers a,b,c,d in the set of positive integers {1, 2, 3, 4...} which satisfy this equation. Sure does!
...
$$\neg (\forall n \in N, P(n)) \equiv \exists n \in N, \neg P(n)$$

$$ \neg (\exists n \in N, Q(n)) \equiv \forall n \in N, \neg Q(n) $$
